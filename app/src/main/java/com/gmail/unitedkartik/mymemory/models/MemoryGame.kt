package com.gmail.unitedkartik.mymemory.models
...
class MemoryGame (private val boardSize: BoardSize) {
    ...
    fun flipCard(position: Int) : Boolean {
        ...
        /*
        Three Cases:
        0 Cards previously flipped over => restore the cards + flip over the selected card (in this there won't be any cards to restore)
